...
namespace YNA\Sniffs\NamingConventions;
...
class ValidVariableNameSniff extends AbstractVariableSniff
{
    ...
    protected function processVariable(File $phpcsFile, $stackPtr)
    {
        ...
        // If it's a YNA reserved var, then it's ok.
        $ynaOkVariables = array_map('trim', explode(';', $this->ynaOkVariables));
        if (in_array($varName, $ynaOkVariables, true)) {
            return;
        }
